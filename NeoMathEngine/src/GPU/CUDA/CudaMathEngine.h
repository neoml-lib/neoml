...
public:
	...
	CActivationDesc* InitActivation( const CActivationInfo& activation, int dataSize ) override;
	bool IsInPlaceActivation( TActivationFunction activation ) override;
	void Activation( const CActivationDesc& desc, const CConstFloatHandle& input,
		const CFloatHandle& output, int dataSize ) override;
	void ActivationBackward( const CActivationDesc& activationDesc, const CConstFloatHandle& input, const CConstFloatHandle& output,
		const CConstFloatHandle& outputDiff, const CFloatHandle& inputDiff, int dataSize ) override;
	...
	void Blob3dConvolutionBackward( const C3dConvolutionDesc& desc, const CFloatHandle& forward, const CFloatHandle& source,
		const CFloatHandle& filter, const CFloatHandle* freeTerm, const CFloatHandle& result ) override;
	void Blob3dConvolutionLearnAdd( const C3dConvolutionDesc& desc, const CFloatHandle& input, const CFloatHandle& output,
	...
	void BlobConvolution( const CConvolutionDesc& desc,
		...
		const CFloatHandle& result ) override;
	void BlobConvolutionBackward( const CConvolutionDesc& desc, const CFloatHandle& output, const CFloatHandle& outputDiff,
		const CFloatHandle& filter, const CFloatHandle* freeTerm, const CFloatHandle& inputDiff ) override;
	void BlobConvolutionLearnAdd( const CConvolutionDesc& desc, const CFloatHandle& input, const CFloatHandle& output,
		const CFloatHandle& outputDiff, const CFloatHandle& filterDiff,
		const CFloatHandle* freeTermDiff, bool isFreeTermDiffFromInput ) override;
	CChannelwiseConvolutionDesc* InitBlobChannelwiseConvolution( const CBlobDesc& input,
		int paddingHeight, int paddingWidth, int strideHeight, int strideWidth,
		const CBlobDesc& filter, const CBlobDesc* freeTerm, const CBlobDesc& output, const CActivationInfo& activation ) override;
	...
	void BlobChannelwiseConvolutionBackward( const CChannelwiseConvolutionDesc& convDesc, const CFloatHandle& forward,
