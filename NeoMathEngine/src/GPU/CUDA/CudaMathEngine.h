...
// CUDA math engine
class CCudaMathEngine : public IMemoryEngine, public IRawMemoryManager {
public:
...
private:
	...
	void getCudaTaskGrid2D( dim3& blockCount, dim3& threadCount, int height, int width, int _maxThreadCount = UINT_MAX ) const;
	void getCudaTaskGrid3D( dim3& blockCount, dim3& threadCount, int batchSize, int height, int width, int _maxThreadCount = UINT_MAX ) const;
	void getCudaTaskGrid2DMinYX( int minY, int minX, dim3& blockCount, dim3& threadCount, int height, int width, int _maxThreadCount = UINT_MAX ) const;
	void getCudaTaskGrid3DMinZYX( int minZ, int minY, int minX, dim3& blockCount, dim3& threadCount,
		int batchSize, int height, int width, int _maxThreadCount = UINT_MAX ) const;
