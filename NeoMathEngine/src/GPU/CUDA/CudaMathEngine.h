...
public:
	...
	{ vectorMultiplyAndAdd( firstHandle, secondHandle, resultHandle, vectorSize, 0, &multHandle ); }
...
private:
	...
	void vectorMultiplyAndAdd( const CConstFloatHandle& firstHandle, const CConstFloatHandle& secondHandle,
		const CFloatHandle& resultHandle, int vectorSize, float multValue, const CConstFloatHandle* multHandle = nullptr );
