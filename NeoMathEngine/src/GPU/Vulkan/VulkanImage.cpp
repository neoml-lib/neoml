	...
	sampler( VK_NULL_HANDLE )
{
	...
	vkSucceded( vkCreateImage( device, &imageInfo, 0, &image ) );
	...
	vkSucceded( vkAllocateMemory( device, &allocInfo, 0, &imageMemory ) );
	vkSucceded( vkBindImageMemory( device, image, imageMemory, 0 ) );
	...
	vkSucceded( vkCreateImageView( device, &imageViewInfo, 0, &imageView ) );
	...
	vkSucceded( vkCreateSampler( device, &samplerInfo, 0, &sampler ) );
}
