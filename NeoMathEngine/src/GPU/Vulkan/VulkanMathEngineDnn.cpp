...
CActivationDesc* CVulkanMathEngine::InitActivation( const CActivationInfo& activation, int dataSize )
{
	size_t bufferSize = 0;
...
bool CVulkanMathEngine::IsInPlaceActivation( TActivationFunction activation )
{
	return activation != AF_Abs && activation != AF_HSwish && activation != AF_GELU;
}

void CVulkanMathEngine::Activation( const CActivationDesc& activationDesc, const CConstFloatHandle& input,
...
void CVulkanMathEngine::ActivationBackward( const CActivationDesc& activationDesc, const CConstFloatHandle& input,
