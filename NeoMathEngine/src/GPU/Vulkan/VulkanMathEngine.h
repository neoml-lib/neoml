...
public:
	...
	CDropoutDesc* InitDropout() override;
	void UpdateDropout(CDropoutDesc* dropoutDesc, float rate, bool isSpatial, bool isBatchwise,
		const CBlobDesc& input, const CBlobDesc& output, int seed, bool valid) override;
