...
--*/
{
    ...
    for (size_t n = 0; n < SegmentCountN; n += CountN) {
        ...
        for (size_t k = 0; k < K; k += CountK) {
            ...
            MlasSgemmOperation(MlasNoTrans, MlasNoTrans, FilterCount, CountN,
...
--*/
{
    ...
    for (size_t bg = BatchGroupStart; bg < BatchGroupEnd; bg++) {
        ...
        MlasSgemmOperation(MlasNoTrans, Parameters->u.GemmDirect.TransB, FilterCount, OutputSize,
        ...
        for (size_t group = 0; group < GroupCount; group++) {
            ...
            switch (Algorithm) {
                ...
                case MlasConvAlgorithmGemmDirect:
                {
                    ...
                    MlasGemm(MlasNoTrans, Parameters->u.GemmDirect.TransB, FilterCount, OutputSize,
                ...
                case MlasConvAlgorithmExpandThenGemm:
                {
                    ...
                    MlasGemm(MlasNoTrans, MlasNoTrans, FilterCount, OutputSize, K, 1.0f, filter,
    ...
    *WorkingBufferSize = 0;
    ...
    if (AllStridesAreOne && AllPaddingIsZero) {
        ...
        if (K == InputChannels) {
            ...
            Parameters->u.GemmDirect.TransB = MlasNoTrans;
        ...
        if (Dimensions == 2 && AllDilationsAreOne && InputChannels == 1) {
            ...
            if (Parameters->KernelShape[1] == Parameters->InputShape[1]) {
                ...
                Parameters->Algorithm = MlasConvAlgorithmGemmDirect;
                Parameters->u.GemmDirect.TransB = MlasTrans;
