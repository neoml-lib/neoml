...
#ifndef MLAS_ENUM_DEFINED_H
#define MLAS_ENUM_DEFINED_H
typedef enum { MlasNoTrans=111, MlasTrans=112, MlasConjTrans=113 } MLAS_TRANSPOSE;
typedef enum { MlasUpper=121, MlasLower=122 } MLAS_UPLO;
typedef enum { MlasNonUnit=131, MlasUnit=132 } MLAS_DIAG;
typedef enum { MlasLeft=141, MlasRight=142} MLAS_SIDE;
#endif
...
MLASCALL
MlasGemmBatch(
    MLAS_TRANSPOSE TransA,
    MLAS_TRANSPOSE TransB,
    size_t M,
    size_t N,
    size_t K,
    ...
    )
{
    ...
    MlasGemmBatch(TransA,
                  MlasTrans,  // deos not matter when B is packed
