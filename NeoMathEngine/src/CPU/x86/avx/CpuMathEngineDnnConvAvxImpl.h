...
template<>
int CBlobConvolution<24>::getBatchProcessSize()
{
	return 3;
}
...
template<>
inline void CBlobConvolution<24>::batchProcess( const float* srcPtr, float* dstPtr, int windowIndex )
{
...
template<>
int CBlobConvolution<18>::getBatchProcessSize()
{
	return 4;
}
...
template<>
inline void CBlobConvolution<18>::batchProcess( const float* srcPtr, float* dstPtr, int windowIndex )
{
...
template<>
int CBlobConvolution<6>::getBatchProcessSize()
{
	return 12;
}
	...
	__m256& r6, __m256& r7, __m256& r8 )
{
	...
	const float* tmpSrcPtr = srcPtr++;
	auto ProcessNext = [&]()
	{
		__m256 f0 = _mm256_loadu_ps( fltPtr );

		__m256 s0 = _mm256_broadcast_ss( tmpSrcPtr );
		__m256 st0 = _mm256_broadcast_ss( tmpSrcPtr + SrcXStep );
		__m256 s1 = _mm256_broadcast_ss( tmpSrcPtr + 4 * SrcXStep );
		__m256 st1 = _mm256_broadcast_ss( tmpSrcPtr + 5 * SrcXStep );
		__m256 s2 = _mm256_broadcast_ss( tmpSrcPtr + 8 * SrcXStep );
		__m256 st2 = _mm256_broadcast_ss( tmpSrcPtr + 9 * SrcXStep );
		tmpSrcPtr += 2 * SrcXStep;
		...
		s0 = _mm256_broadcast_ss( tmpSrcPtr );
		s1 = _mm256_broadcast_ss( tmpSrcPtr + 4 * SrcXStep );
		s2 = _mm256_broadcast_ss( tmpSrcPtr + 8 * SrcXStep );
		tmpSrcPtr += SrcXStep;
		...
		st0 = _mm256_broadcast_ss( tmpSrcPtr );
		st1 = _mm256_broadcast_ss( tmpSrcPtr + 4 * SrcXStep );
		st2 = _mm256_broadcast_ss( tmpSrcPtr + 8 * SrcXStep );
...
template<>
inline void CBlobConvolution<6>::batchProcess( const float* srcPtr, float* dstPtr, int windowIndex )
{
		__m256 ft0 = freeTerm != nullptr ? _mm256_loadu_ps( freeTerm ) : _mm256_setzero_ps();
