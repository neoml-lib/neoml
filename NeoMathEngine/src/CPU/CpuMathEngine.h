...
public:
	...
	virtual TMathEngineType GetType() const override { return MET_Cpu; }
	virtual void SetReuseMemoryMode( bool enabled ) override;
	...
	virtual IPerformanceCounters* CreatePerformanceCounters() const override;
