...
void CCpuMathEngine::ScatterND( const CConstFloatHandle& updatesHandle, const CConstIntHandle& indicesHandle,
...
void CCpuMathEngine::ScatterND( const CConstIntHandle& updatesHandle, const CConstIntHandle& indicesHandle,
