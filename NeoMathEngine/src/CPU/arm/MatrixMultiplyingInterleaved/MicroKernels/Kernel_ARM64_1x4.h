...
// The micro-kernel size is 1*4. The temporary variables are stored in q7 registers
...
//
// <---q0----> <---q7---->
struct CMicroKernel1x4 : public CMicroKernelBase<1, 4> {
	static void Calculate(const float* aPtr, const float* bPtr, float* cPtr, size_t /*cRowSize*/, size_t k)
	{
		...
		"1:\n"
			...
			"fmla   v7.4s,  v2.4s, v0.s[1]\n"
			"fmla   v7.4s,  v3.4s, v0.s[2]\n"
			"fmla   v7.4s,  v4.4s, v0.s[3]\n"
