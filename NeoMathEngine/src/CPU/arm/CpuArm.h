...
public:
	CLogNeon() :
		...
		Poly0(vdupq_n_f32(-3.2455378908344916948407877000353442459011384397788)),
		Poly1(vdupq_n_f32(7.1339697587175455049710506400694511078608936803231)),
		Poly2(vdupq_n_f32(-7.4941301702013735851537600249526540092443115748036)),
		Poly3(vdupq_n_f32(5.7814391128063934552219828081324846781193662335884)),
		Poly4(vdupq_n_f32(-2.9850210971839599885298460999162497066040129520082)),
		Poly5(vdupq_n_f32(0.97809484672002024331867404574282052989016615150109)),
		Poly6(vdupq_n_f32(-0.18393964185915930347326184521224405147146836036687)),
		Poly7(vdupq_n_f32(1.51253591244695233686664732830614377023939188635574e-2)),
