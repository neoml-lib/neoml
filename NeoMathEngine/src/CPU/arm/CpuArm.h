...
public:
	CLogNeon() :
		...
		Poly0(vdupq_n_f32(-1.94106443457834637877189893857044282721818904744502)),
		Poly1(vdupq_n_f32(3.52930499056893315520004153423492192522706029766775)),
		Poly2(vdupq_n_f32(-2.461222101206192804243374537539545036646977779624)),
		Poly3(vdupq_n_f32(1.1306261641034967379010138196680730502944104380795)),
		Poly4(vdupq_n_f32(-0.28873994395954114739128358706524807994337829844445)),
		Poly5(vdupq_n_f32(3.1104016267039697177724879617551599996102405989509e-2)),
		Poly6(vdupq_n_f32(0)),
		Poly7(vdupq_n_f32(0)),
