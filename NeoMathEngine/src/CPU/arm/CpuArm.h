...
public:
	CLogNeon() :
		...
		Poly0(vdupq_n_f32(-3.8601145720753851437786527264180712774576086256518)),
		Poly1(vdupq_n_f32(11.2166689347598054773664668051784300474043480918157)),
		Poly2(vdupq_n_f32(-19.710898538217570609583828650328537760215712999633)),
		Poly3(vdupq_n_f32(27.558091170094384265990781849606731289608776127459)),
		Poly4(vdupq_n_f32(-28.739000937808080025249377813854333939765958108034)),
		Poly5(vdupq_n_f32(22.2562386120343825565725615357845548488170753070654)),
		Poly6(vdupq_n_f32(-12.7549684354751499244270048441440740471148579444635)),
		Poly7(vdupq_n_f32(5.3417030704634660625579731269867567220299296649758)),
		Poly8(vdupq_n_f32(-1.5900916219137031467846325281898800188614085028521)),
		Poly9(vdupq_n_f32(0.31888039357606079336667833838154959809325089157414)),
		Poly10(vdupq_n_f32(-3.8647694954575882379788120270994404476141968324182e-2)),
		Poly11(vdupq_n_f32(2.1396196768540193467080775102526967379958839248562e-3)),
