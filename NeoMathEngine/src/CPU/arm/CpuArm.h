...
public:
	CLogNeon() :
		...
		Poly0(vdupq_n_f32(-2.8003640338121200657241122927757517642737008553641)),
		Poly1(vdupq_n_f32(5.0917108076784696311271957881255099495857163635808)),
		Poly2(vdupq_n_f32(-3.5507929199364887613234179425811153450401888875831)),
		Poly3(vdupq_n_f32(1.63114876005142607771769847079179872435783869209304)),
		Poly4(vdupq_n_f32(-0.41656368525698721844050117105622824100025464699053)),
		Poly5(vdupq_n_f32(4.4873610020187818884731816448989310646251585786296e-2)),
		Poly6(vdupq_n_f32(0)),
		Poly7(vdupq_n_f32(0)),
