...
static void matrixLogSumExpByColumnsTestImpl( const CTestParams& params, int seed )
{
	CRandom random( seed );
...
class CMatrixLogSumExpByColumnsTest : public CTestFixtureWithParams {
};

INSTANTIATE_TEST_CASE_P( CMatrixLogSumExpByColumnsTestInstantiation, CMatrixLogSumExpByColumnsTest,
	::testing::Values(
		CTestParams(
			"Height = (1..50);"
			"Width = (1..50);"
...
TEST_P( CMatrixLogSumExpByColumnsTest, Random )
{
	RUN_TEST_IMPL( matrixLogSumExpByColumnsTestImpl )
}
