...
namespace NeoOnnx {
//--------------------------------------------------------------------------------------------------------------
CPtr<CBaseLayer> IOptimizer::GetAnyInputLayer( CPtr<CBaseLayer>& currentLayer, int i, const char* const layerSkipClass )
{
...
//--------------------------------------------------------------------------------------------------------------
bool IOptimizer::IsExactLayer( CPtr<CBaseLayer>& layer, const char* layerClass, bool justCheck )
{
...
//--------------------------------------------------------------------------------------------------------------
bool IOptimizer::GetExactInputLayers( CPtr<CBaseLayer>& currentLayer,
