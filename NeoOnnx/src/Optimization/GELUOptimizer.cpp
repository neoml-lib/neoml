...
bool replaceNewVerGELU( CGraph& graph, CBaseLayer& halfLayer )
{
...
// Detects and replace GELU generated by older version of PyTorch
// -+- -> Div(Sqrt2) -> Erf -> Add(1) -> Mul ->
//  |                                     |
//  +------------------------> Div(2) ----+
bool replaceOldVerGELU( CGraph& graph, CBaseLayer& lastLayer )
{
	for( int addOneIndex = 0; addOneIndex < 2; ++addOneIndex ) {
		graph.ClearSelection();
