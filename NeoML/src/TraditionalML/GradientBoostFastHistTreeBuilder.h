...
private:
	...
	struct CNode {
		...
		T LeftStatistics; // computed statistics of the left child
		T RightStatistics; // computed statistics of the right child
	...
	mutable CArray<T> leftStatisticsBuffer;
	mutable CArray<T> rightStatisticsBuffer;
