...
private:
	...
	float lossWeight = 1.f; // the weight for the loss function
	float lossDivider = 0.f; // the averaging factor for calculating the loss value
	float minGradient = 0.f;
	float maxGradient = 0.f;

	bool trainLabels = false; // indicates if the first input should be trained against the correct result
