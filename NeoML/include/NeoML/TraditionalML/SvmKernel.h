...
public:
	...
	double Calculate(const CFloatVector& x1, const CFloatVectorDesc& x2) const;
...
private:
	...
	double linear(const CFloatVector& x1, const CFloatVectorDesc& x2) const;
	double poly(const CFloatVectorDesc& x1, const CFloatVectorDesc& x2) const;
	double poly(const CFloatVector& x1, const CFloatVectorDesc& x2) const;
