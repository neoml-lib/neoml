...
// Класс для параметров тестов.
// Инициализируется на основе строки вида "флаг1 = значение1; флаг2 = значение; ...".
class CTestParams {
public:
	...
	// Получить значение заданного типа.
	template<class T>
	T GetValue( const CString& key ) const;
	
	// Получить массив значений заданного типа.
	template<class T>
...
private:
	CMap<CString, CString> flags; // Имеющиеся флаги.
...
// Специализация для массива интервалов.
template<>
