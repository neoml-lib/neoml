// Copyright (c) 1993-2016, ABBYY (BIT Software). All rights reserved.
//	Автор: Валинуров Денис
...
{
	// AS_Additive у этого слоя это параметр по умолчанию, но мы все равно его используем
	// потому что с другими значениями нельзя протестить методы CAttentionLayer::Get*Data
