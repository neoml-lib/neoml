...
static void createDnn( CDnn& dnn, bool isNaive, int complexity = 1000, float dropoutRate = 0.3f, bool freeTerm = false )
{
    ...
    CPtr<CFullyConnectedLayer> fc01 = FullyConnected( complexity / 20, freeTerm )( "fc01", source1.Ptr() );
    CPtr<CFullyConnectedLayer> fc02 = FullyConnected( complexity / 20, freeTerm )( "fc02", source2.Ptr() );
    CPtr<CFullyConnectedLayer> fc03 = FullyConnected( complexity / 20, freeTerm )( "fc03", source3.Ptr() );
    ...
    if( isNaive ) {
        ...
        CPtr<CFullyConnectedLayer> fc1 = FullyConnected( 3 * complexity, freeTerm )( "fc1", fc01.Ptr(), fc02.Ptr(), fc03.Ptr() );
