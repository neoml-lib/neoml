...
if [[ $FINE_CMAKE_BUILD_TARGET == "IOS" ]]; then
	...
	export PATH=$PATH:$ROOT/ThirdParty/CUDA/Linux/nvcc/bin
	export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$ROOT/ThirdParty/CUDA/Linux/nvcc/lib64
	export CPLUS_INCLUDE_PATH=$CPLUS_INCLUDE_PATH:$ROOT/ThirdParty/CUDA/Linux/nvcc/include
