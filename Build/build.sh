...
elif [[ $FINE_CMAKE_BUILD_TARGET == "Linux" && $FINE_CMAKE_BUILD_ARCH == "x86_64" ]]; then
	export PATH=$ROOT/ThirdParty/CUDA/Linux/nvcc/bin:$PATH
	export LD_LIBRARY_PATH=$ROOT/ThirdParty/CUDA/Linux/nvcc/lib64:$LD_LIBRARY_PATH
	export CPLUS_INCLUDE_PATH=$ROOT/ThirdParty/CUDA/Linux/nvcc/include:$CPLUS_INCLUDE_PATH
